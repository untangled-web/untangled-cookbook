(defproject untangled/demo "1.0.0"
  ...
  :dependencies [[com.datomic/datomic-free "0.9.5206" :exclusions [joda-time]]
                 ...
                 [juxt/dirwatch "0.2.3"]
                 [navis/untangled-client "0.5.7-SNAPSHOT" :exclusions [cljsjs/react org.omcljs/om]]
  ...
  :source-paths ["dev/server" "src/server" "checkouts/client"]
  ...
  :cljsbuild {:builds
              [{:id           "dev"
                :source-paths ["src/client" "dev/client" "checkouts/client"]
                :figwheel     true
